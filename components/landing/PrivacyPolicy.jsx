...
export default function PrivacyPolicy({ onGoto }) {
  return (
    <LegalDocument
      onGoto={onGoto}
      ...
      seo={{
        title: "Privacy Policy — Leadnator",
        description:
          "Leadnator Privacy Policy: how we collect, use, store and protect personal data for WhatsApp CRM, Meta Ads and email marketing services.",
        canonical: "https://leadnator.com/privacy-policy",
        keywords: "Leadnator privacy policy, WhatsApp CRM data privacy, GDPR India",
      }}
    >
