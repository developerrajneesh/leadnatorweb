...
export default function About({ onGoto }) {
  useSeo({
    title: "About Us — Leadnator, India's AI Growth CRM",
    description:
      "Learn about Leadnator — the all-in-one WhatsApp CRM, Meta Ads and email marketing platform built for Indian businesses. Our mission, team and values.",
    canonical: "https://leadnator.com/about",
    keywords: "About Leadnator, WhatsApp CRM company India, AI growth platform",
  });

  return (
    <MarketingLayout onGoto={onGoto} currentPath="/about">
      <Hero />
      <Mission />
      <StatsBar />
      <Values />
