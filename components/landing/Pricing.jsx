...
export default function Pricing({ onGoto }) {
  useSeo({
    ...
    description:
      "Leadnator pricing: Starter ₹299, Growth ₹499, Pro ₹999. WhatsApp API wallet, Meta Ads, email and CRM included. Monthly to yearly billing with up to 15% off.",
    canonical: "https://leadnator.com/pricing",
    keywords: "WhatsApp API pricing India, CRM pricing INR, Leadnator plans",
  });
